...
const navigation = [
  ...
  { id: 'accounts', label: 'Supplier accounts', icon: Activity },
    ...
    <div className="app-shell">
      ...
      <main className="main-panel">
        ...
        <div className="page-content">
          ...
          {active === 'accounts' && (token ? <AccountsPage key={token} token={token} /> : <Page title="Supplier accounts" subtitle="Optional subscription and capacity observation."><section className="panel"><ConnectPrompt draft={draftToken} error={error} onChange={setDraftToken} onSubmit={connect} /></section></Page>)}
